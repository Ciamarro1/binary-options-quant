...
const TrendConditionedRatioZScoreModel = require('../models/TrendConditionedRatioZScoreModel');
...
class H006Runner {
  constructor(observations, options = {}) {
    ...
    this.modelClass = options.modelClass || TrendConditionedRatioZScoreModel;
  }
  ...
  runSlice(startIndex, endIndex) {
    ...
    const wilsonCI = H006Runner.computeWilsonCI(totalWins, totalNonPush);
